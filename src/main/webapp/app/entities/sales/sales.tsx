            ...
            <tbody>
              {salesList.map((sales, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {sales.deliveredDate ? <TextFormat type="date" value={sales.deliveredDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {sales.finalDeliveredDate ? (
                      <TextFormat type="date" value={sales.finalDeliveredDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
