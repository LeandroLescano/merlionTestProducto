        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : salesEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="deliveredDateLabel" for="sales-deliveredDate">
                  <Translate contentKey="testApp.sales.deliveredDate">Delivered Date</Translate>
                </Label>
                <AvField id="sales-deliveredDate" type="date" className="form-control" name="deliveredDate" />
              </AvGroup>
              <AvGroup>
                <Label id="finalDeliveredDateLabel" for="sales-finalDeliveredDate">
                  <Translate contentKey="testApp.sales.finalDeliveredDate">Final Delivered Date</Translate>
                </Label>
                <AvField id="sales-finalDeliveredDate" type="date" className="form-control" name="finalDeliveredDate" />
              </AvGroup>
              <AvGroup>
                <Label id="amountPaidLabel" for="sales-amountPaid">
                  <Translate contentKey="testApp.sales.amountPaid">Amount Paid</Translate>
                </Label>
                <AvField id="sales-amountPaid" type="string" className="form-control" name="amountPaid" />
              </AvGroup>
              <AvGroup>
