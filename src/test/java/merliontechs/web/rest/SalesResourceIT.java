...
public class SalesResourceIT {
    ...
    private static final LocalDate DEFAULT_FINAL_DELIVERED_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_FINAL_DELIVERED_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final Float DEFAULT_AMOUNT_PAID = 1F;
    private static final Float UPDATED_AMOUNT_PAID = 2F;

    private static final Float DEFAULT_FULL_PAYMENT = 1F;
    private static final Float UPDATED_FULL_PAYMENT = 2F;
    ...
    public static Sales createEntity(EntityManager em) {
        Sales sales = new Sales()
            ...
            .finalDeliveredDate(DEFAULT_FINAL_DELIVERED_DATE)
    ...
    public static Sales createUpdatedEntity(EntityManager em) {
        Sales sales = new Sales()
            ...
            .finalDeliveredDate(UPDATED_FINAL_DELIVERED_DATE)
    ...
    public void createSales() throws Exception {
        ...
        assertThat(testSales.getDeliveredDate()).isEqualTo(DEFAULT_DELIVERED_DATE);
        assertThat(testSales.getFinalDeliveredDate()).isEqualTo(DEFAULT_FINAL_DELIVERED_DATE);
        assertThat(testSales.getAmountPaid()).isEqualTo(DEFAULT_AMOUNT_PAID);
    ...
    public void getAllSales() throws Exception {
        ...
        restSalesMockMvc.perform(get("/api/sales?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].finalDeliveredDate").value(hasItem(DEFAULT_FINAL_DELIVERED_DATE.toString())))
            .andExpect(jsonPath("$.[*].amountPaid").value(hasItem(DEFAULT_AMOUNT_PAID.doubleValue())))
            .andExpect(jsonPath("$.[*].fullPayment").value(hasItem(DEFAULT_FULL_PAYMENT.doubleValue())));
    }
    ...
    public void getSales() throws Exception {
        ...
        restSalesMockMvc.perform(get("/api/sales/{id}", sales.getId()))
            ...
            .andExpect(jsonPath("$.finalDeliveredDate").value(DEFAULT_FINAL_DELIVERED_DATE.toString()))
            .andExpect(jsonPath("$.amountPaid").value(DEFAULT_AMOUNT_PAID.doubleValue()))
            .andExpect(jsonPath("$.fullPayment").value(DEFAULT_FULL_PAYMENT.doubleValue()));
    }
    @Test
    @Transactional
    ...
    public void updateSales() throws Exception {
        ...
        assertThat(testSales.getDeliveredDate()).isEqualTo(UPDATED_DELIVERED_DATE);
        assertThat(testSales.getFinalDeliveredDate()).isEqualTo(UPDATED_FINAL_DELIVERED_DATE);
        assertThat(testSales.getAmountPaid()).isEqualTo(UPDATED_AMOUNT_PAID);
